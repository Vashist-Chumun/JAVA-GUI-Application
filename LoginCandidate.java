...
public class LoginCandidate extends JFrame
{
	// Components of the Candidate Panel 
	private Container l1;
	...
	public LoginCandidate()
	{
		...
		title = new JButton("Welcome Dear Candidate, Log In To Access E-Voting System");
		...
		l1.add(label_username);			//add label_username to JFrame
        ...
        forgot_password.addActionListener((ActionListener) new ActionListener()
        {
        	...
        	{
        		JOptionPane.showMessageDialog(l1, "Dear candidate, new credential is sent to your phone number!");
        	}
        });
		...
		login_But.addActionListener((ActionListener) new ActionListener() { 
			...
			public void getdb() throws ClassNotFoundException, SQLException {     //GETS DATA FROM DATABASE
		        ...
		        if (rs.next()) {
		        	...
		        	dispose();
		        	JOptionPane.showMessageDialog(l1,"Enter The Home Page");
		        	...
		        	JOptionPane.showMessageDialog(l1,"username or password is wrong!!!");
			  ...
			  public void actionPerformed(ActionEvent e) { 
				...
				if(field_username.getText() != null && field_username.getText().equals(""))
					{
						JOptionPane.showMessageDialog(l1, "Please enter a username!");
					}
				else if (field_password.getPassword().length == 0)
					{    
						JOptionPane.showMessageDialog(l1, "Please enter a password!");
					}
