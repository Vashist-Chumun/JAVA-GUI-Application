...
public class RulesCand extends JFrame
{
	...
	public RulesCand() throws IOException
	{
	...
	public static void main(String[] args) throws IOException
	{
		...
		setNimbusFeel();
		RulesCand rulecand = new RulesCand();
	}
	...
	private static void setNimbusFeel(){
	    try {
	        ...
	        java.util.logging.Logger.getLogger(RulesCand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
