...
public class RegisterPageCandidate extends JFrame implements ActionListener
{
    ...
    public RegisterPageCandidate()
    {
		...
		title = new JButton("Welcome To Candidate Registration Form");
	    ...
	    // --------------- PARTY ------------------------------
        party = new JLabel("Party");
        party.setFont(new Font("Javanese Text", Font.BOLD, 14));
        party.setBounds(55, 440, 90, 20);
        c.add(party);
  
        // First Name Text Field
	    t_party = new JTextField();
	    t_party.setFont(new Font("Times New Roman", Font.BOLD, 13));
	    t_party.setBounds(150, 440, 190, 20);
	    t_party.setBackground(new Color(255, 253, 230));
	    t_party.setHorizontalAlignment(JTextField.CENTER);
	    t_party.setBorder(border);
	    c.add(t_party);
        ...
        sub.setBounds(350, 520, 85, 20);
        sub.setBackground(new Color(255, 253, 230));
        ...
        title2 = new JLabel("Candidate Information");
        title2.setFont(new Font("Javanese Text", Font.BOLD, 13));
        title2.setBounds(590, 75, 190, 20);
        c.add(title2);
        ...
        res.setBounds(325, 555, 350, 20);
        c.add(res);
        
        resadd = new JTextArea();
        resadd.setFont(new Font("Times New Roman", Font.PLAIN, 13));
        resadd.setBounds(450, 520, 85, 20);
		...
		backcand2 = new JButton("Back To Candidate Page");
    ...
    public void setdb() throws SQLException, ClassNotFoundException {	//INSERTS DATA INTO DATABASE
		...
		String dbparty = t_party.getText();
	    ...
	    */
		...
		+dbgender+"', '"+dbdate+"', '"+dbemail+"', '"+dbdistrict+"', '"+dbadd+"', '"+dbparty+"');";
    ...
    public void writefile(String data0, String data, String data1, String data2, String data3, String data4) throws IOException {
		File output = new File("C:\\Users\\User\\Desktop\\DataCandidate.txt");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if (e.getSource() == sub) {
            ...
            if (term.isSelected()) {
                ...
                tout.setEditable(false);
                res.setText("You have successfully Registered!");
                try {
	...
	private static void setNimbusFeel(){
	    try {
	        ...
	        java.util.logging.Logger.getLogger(RegisterPageCandidate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
